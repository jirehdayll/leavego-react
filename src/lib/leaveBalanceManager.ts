...
export function convertDBBalanceToLeaveBalances(dbBalance: any): LeaveBalances {
  console.log('[convertDBBalanceToLeaveBalances] Input dbBalance:', dbBalance);
  
  if (!dbBalance) {
    console.log('[convertDBBalanceToLeaveBalances] No dbBalance provided, returning defaults');
    return {
      forced_leave: 5,
      special_leave_privileges: 3,
      wellness_leave: 5,
