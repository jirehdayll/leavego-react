-- =========================================================
-- Fix Balance Deduction Trigger with Shared Deduction
-- =========================================================
-- This migration fixes the deduct_leave_on_approval trigger to:
-- 1. Read both num_days and number_of_days from details
-- 2. Handle all leave types correctly
-- 3. Deduct from vacation/sick leave for forced/special/wellness leave
-- 4. Ensure atomic transaction with approval
--
...
-- 1. Specific leave type balance is deducted (e.g., forced_leave_balance - 2 days)
-- 2. Vacation leave balance is deducted (half the days, e.g., vacation_leave_balance - 1 day)
-- 3. Sick leave balance is deducted (half the days, e.g., sick_leave_balance - 1 day)
-- 4. All deductions are logged in leave_balance_transactions table
-- =========================================================